export const APARTMENT_DATA = {
  ...
  engineering: [
    ...
    },
    {
      ...
      model: 'КСК 20-2,5 К',
      sourceNote: 'Размер принят по паспорту Универсал двухрядный концевой КСК 20: монтажный № 2У21, тепловой поток 2,5 кВт, L=1126 мм, L1=1229 мм; глубина принята 160 мм как предельная глубина кожуха по паспорту.'
    },
    {
